...
You are editing `docs/plans/*.md` or `docs/specs/*.md`. In the same turn, `docs/REMAINING_TASKS.md` and `docs/CURRENT_WORK.md` likely also need updates.
...
1. **`docs/REMAINING_TASKS.md`** — task status / external-dependency list / phase checklist (search by task ID *and* keyword to catch drift).
