...
- `docs/REMAINING_TASKS.md` task item closed.
- `docs/CURRENT_WORK.md` `+N` entry appended.
...
If `your-project` does not use `git push origin` as the canonical "shipped" signal (e.g., trunk-based with direct deploy from CI artifact), edit this rule body's "evidence" section to match the actual shipped signal. Do NOT delete the rule outright — the underlying principle (verify-before-claim) is universal.
