...
if [ "${CONDUCTOR_CLI_DISPATCH:-0}" = "2" ]; then
  ...
  if node "$CONDUCTOR_ROOT/bin/adapter-dispatch.js" verify codex; then
...
do_uninstall() {
  ...
  for d in .agents/skills/reflect .agents/skills/coordinate-work .agents/skills/propose-skill .agents/skills/plan-change .agents/skills/verify-change .agents/skills/review-change .agents/skills .agents .codex/agents .codex/hooks .codex/conductor/rules .codex/conductor/recipes .codex/conductor .codex .conductor/reflect .conductor/manifests .conductor docs/plans docs/architecture docs/research docs/specs docs; do
