...
- Keep portable rules in `core/`; compile tool-native behavior in one of the seven
...
- Treat Claude Code, Cursor, GitHub Copilot, Gemini CLI, Codex, Windsurf, and OpenCode as
